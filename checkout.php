                ...
                <div class="row row-col-1 justify-content-center">
                    ...
                    <div class="form-group d-flex pl-2">
                        ...
                        <h4 class="text-muted">Payment Method</h4>
                            ...
                            <br>
                            <div class="d-flex w-100 justify-content-between">
                            <button class="btn btn-flat btn-dark"><a href="lipa.php">Lipa Na Mpesa</a></button>
                            </div>
                        </div>
                    </div>
                </div>
...
paypal.Button.render({
    env: 'sandbox', // change for production if app is live,
        ...
        //app's client id's
	client: {
        sandbox:    'Aa1CpS46m-LJ3qTEmd_CnywTRgGoSMKel1cD9LN91EvvBXSBF2ah2Nhitfe9LjSencYKJfiur_kaJZA7',
        //production: 'EDvVBAPP83Nl3hyn3BE3UbfY6zfYJG2PO3iB-Ns9xk366Xd9_CexSKvgvyGihw6XZdiL5eRTuo23r52K'
    },
